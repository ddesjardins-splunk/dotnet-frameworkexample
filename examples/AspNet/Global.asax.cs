...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        protected void Application_Start()
        {
            var builder = Sdk.CreateTracerProviderBuilder()
                .SetResourceBuilder(ResourceBuilder.CreateDefault().AddService("ExampleService"))
            ...
            {
                // otlpOptions.Endpoint = new Uri("http://ec2-18-218-102-138.us-east-2.compute.amazonaws.com:4317");
